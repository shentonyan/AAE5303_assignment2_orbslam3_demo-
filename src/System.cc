...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    /* Monocular/IMU-monocular also support full-frame trajectory via mlRelativeFramePoses in Tracking */
    ...
    if(vpKFs.empty())
    {
        cerr << "ERROR: No keyframes in map, cannot save trajectory." << endl;
        return;
    }
